...
const shoes = [
  ...
  { id: 1, name: "Nike Air Force 1 '07", price: 2490000, brand: "Nike", image: "./imgweb/nike_1.jpg", desc: "Biểu tượng thời trang đường phố." },
  ...
  { id: 4, name: "Nike Court Legacy", price: 1900000, brand: "Nike", image: "./imgweb/nike_4.jpg", desc: "Phong cách tennis cổ điển." },
  { id: 5, name: "Nike Dunk Low Retro", price: 3500000, brand: "Nike", image: "./imgweb/nike_5.jpg", desc: "Cực kỳ cá tính và nổi bật." },

  // --- 2. ADIDAS (5 mẫu) ---
  { id: 6, name: "Adidas Samba OG", price: 2800000, brand: "Adidas", image: "./imgweb/adidas_1.jpg", desc: "Mẫu giày 'quốc dân' hiện nay." },
  { id: 7, name: "Adidas Gazelle Bold", price: 3100000, brand: "Adidas", image: "./imgweb/adidas_2.jpg", desc: "Đế cao tôn dáng cho các bạn nữ." },
  { id: 8, name: "Adidas Campus 00s", price: 2300000, brand: "Adidas", image: "./imgweb/adidas_3.jpg", desc: "Vẻ đẹp vượt thời gian." },
  { id: 9, name: "Adidas Ultraboost Light", price: 5000000, brand: "Adidas", image: "./imgweb/adidas_4.jpg", desc: "Công nghệ đệm Boost êm nhất thế giới." },
  { id: 10, name: "Adidas Forum Low", price: 2500000, brand: "Adidas", image: "./imgweb/adidas_5.jpg", desc: "Phong cách bóng rổ thập niên 80." },

  // --- 3. JORDAN (Đã thêm 1 mẫu mới - ID 15) ---
  { id: 11, name: "Jordan 1 Low Panda", price: 3800000, brand: "Jordan", image: "./imgweb/jordan_1.jpg", desc: "Phối màu trắng đen dễ mặc nhất." },
  { id: 12, name: "Jordan 1 Mid Grey", price: 4200000, brand: "Jordan", image: "./imgweb/jordan_2.jpg", desc: "Màu xám thanh lịch, sang trọng." },
  { id: 13, name: "Jordan Stay Loyal 2", price: 3600000, brand: "Jordan", image: "./imgweb/jordan_3.jpg", desc: "Hỗ trợ bảo vệ cổ chân cực tốt." },
  { id: 14, name: "Jordan 1 High OG", price: 5500000, brand: "Jordan", image: "./imgweb/jordan_4.jpg", desc: "Đẳng cấp từ dòng High-top huyền thoại." },
  { id: 15, name: "Jordan 4 Retro", price: 6200000, brand: "Jordan", image: "./imgweb/jordan_5.jpg", desc: "Thiết kế hầm hố, phong cách hip-hop mạnh mẽ." },

  // --- 4. PUMA (Đã thêm 4 mẫu mới - ID 16 -> 20) ---
  { id: 16, name: "Puma Suede Classic", price: 2100000, brand: "Puma", image: "./imgweb/puma_3.jpg", desc: "Chất liệu da lộn mềm mại, lịch lãm." },
  { id: 17, name: "Puma RS-X Efekt", price: 3200000, brand: "Puma", image: "./imgweb/puma_1.jpg", desc: "Thiết kế Chunky hiện đại, phá cách." },
  { id: 18, name: "Puma Cali Dream", price: 2600000, brand: "Puma", image: "./imgweb/puma_2.jpg", desc: "Mang lại vẻ ngoài trẻ trung và năng động." },
  { id: 19, name: "Puma MB.01 Lamelo", price: 3900000, brand: "Puma", image: "./imgweb/puma_4.jpg", desc: "Dòng giày bóng rổ hiệu năng cao." },
  { id: 20, name: "Puma Mayze Wedge", price: 2900000, brand: "Puma", image: "./imgweb/puma_5.jpg", desc: "Đế xuồng cá tính dành riêng cho phái đẹp." }
];
